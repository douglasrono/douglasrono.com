            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p>
                            Hi, <br> I'm Douglas Rono, a software developer with a passion for building high-quality web
                            applications using Laravel,Node, Express and Vue.
                        </p>
                        <p>
                            I have 5 years of experience in the industry and have worked on a variety of projects, ranging
                            from small startups to large enterprise applications.
                            I specialize in developing custom web applications that meet the specific needs of my clients.My
                            expertise lies in Laravel and Vue, two of the most popular frameworks in the web development
                            industry.
                            I use these tools to build scalable, maintainable, and secure applications that are easy to
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                            In addition to my technical skills, I am also a strong communicator and collaborator. I believe
                            in working closely with my clients to understand their needs and deliver solutions that exceed
                        ...
                        <p>
                            If you're interested in working with me or learning more about my experience, please feel free
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <p class="description"> I have extensive experience with front-end development using JavaScript
                                and Vue.
                                I can create responsive, user-friendly interfaces that provide a seamless user experience.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <p class="description">I have expertise in SQL and can design and develop databases that are
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 d-flex align-items-stretch">
                        <div class="card" style='background-image: url("assets/img/pic7.png");' data-aos="fade-up"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">I offer ongoing maintenance and support for the applications that I
                                    develop. This includes bug fixes, updates,
                    ...
                    <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                        <div class="card" style='background-image: url("assets/img/pic10.avif");' data-aos="fade-up"
                            data-aos-delay="200">
                            <div class="card-body">
                                <h5 class="card-title"><a href="">CMS Development</a></h5>
                                <p class="card-text">I can help you build a custom CMS that makes it easy to manage your
                                    website's content, while also providing advanced features and functionality.</p>
                    ...
                    <div class="col-md-6 d-flex align-items-stretch mt-4">
                        <div class="card" style='background-image: url("assets/img/hero-img.png");' data-aos="fade-up"
                            data-aos-delay="100">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 d-flex align-items-stretch mt-4">
                        <div class="card" style='background-image: url("assets/img/hero.jpg");' data-aos="fade-up"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">I can provide consulting services to help you make informed decisions
                                    about your technology stack and development process.
                                    I also offer training sessions to help your team learn new technologies and techniques.
                                </p>
        ...
        <section id="faq" class="faq">
            <div class="container">
                ...
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-7">
                        <p>
                            I have worked on a wide range of projects, including custom CMS development, e-commerce platform
                            development, database design and optimization, front-end development, and more.
                ...
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-7">
                        <p>
                            I believe in working closely with my clients to understand their business needs and goals. I
                            start by gathering requirements and conducting a thorough analysis of the project's technical
                            and business requirements. I then develop a project plan that outlines the scope, timeline, and
                            budget for the project.
                            Throughout the project, I provide regular updates and communicate closely with my clients to
                            ensure that the project is delivered on time and on budget.
                        </p>
                    </div>
                </div><!-- End F.A.Q Item-->
                ...
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="col-lg-7">
                        <p>
                            I believe that quality assurance is a critical part of the software development process. I
                            follow a rigorous testing process that includes unit testing,
                            integration testing, and user acceptance testing. I also use tools and techniques such as code
                ...
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="col-lg-7">
                        <p>
                            Yes, I offer ongoing support and maintenance for all the projects I work on. This includes bug
                            fixes,
                ...
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="col-lg-7">
                        <p>
                            My availability for new projects varies depending on my current workload. Please get in touch to
                            discuss your project and availability.
                        </p>
                    </div>
                </div><!-- End F.A.Q Item-->
                <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="col-lg-7">
                        <p>
                            : I start by conducting a thorough discovery phase to understand your business needs and goals.
                            From there, I create a detailed project plan that outlines the scope, timeline,
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-about">
                            <h3>Douglas Rono</h3>
                            <p>
                                Do you have any projects that you'd wish to discuss? Don't hesitate to reach out on me, I’ll
